 ...
 */
var getIP = function () { return __awaiter(void 0, void 0, void 0, function () {
    var ret, lines, ans, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exec('ipconfig | findstr /c:"IPv4"')];
            case 1:
                ret = _a.sent();
                if (ret.stderr !== null) {
                    ...
                    ans = ans.replace('\r', '');
                    return [2 /*return*/, ans.split(':')[1].trimStart()];
                }
                return [2 /*return*/];
        }
    });
